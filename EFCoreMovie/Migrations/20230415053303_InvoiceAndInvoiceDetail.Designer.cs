...
namespace EFCoreMovie.Migrations
{
    ...
    [Migration("20230415053303_InvoiceAndInvoiceDetail")]
    partial class InvoiceAndInvoiceDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreMovie.Entities.Keyless.MovieWithCount", b =>
                {
                    ...
                    b.ToView("MovieWithCounts", (string)null);
                });

            modelBuilder.Entity("EFCoreMovie.Entities.LogEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EFCoreMovie.Entities.MessageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreMovie.Entities.MessageEntity", b =>
                {
                    b.HasOne("EFCoreMovie.Entities.PersonEntity", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCoreMovie.Entities.PersonEntity", "Sender")
